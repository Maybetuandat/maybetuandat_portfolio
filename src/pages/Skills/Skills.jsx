  ...
  const skillCategories = [
...

    {
      ...
      skills: [
        ...
        {
          name: "OpenStack",
          icon: <SiOpenstack className="w-4 h-4 text-[#ED1944]" />,
        },
        {
          name: "Arch Linux",
          icon: <SiArchlinux className="w-4 h-4 text-[#1793D1]" />,
        },
        ...
        {
          name: "Ubuntu",
          icon: <SiUbuntu className="w-4 h-4 text-[#E95420]" />,
        },
      ],
    },
    {
      ...
      skills: [
        ...
        {
          name: "Vim",
          icon: <SiVim className="w-4 h-4 text-[#019733]" />,
        },

        {
          name: "ArgoCD",
          icon: <SiArgo className="w-4 h-4 text-[#EF7B4D]" />,
        },
        {
          name: "Jenkins",
